...
public class Maze : MonoBehaviour {
    ...
    private void CreateCell1(int x, int y)//grindys
    {
        ...
        MazeLub newCells = Instantiate(cellLub);
        newCells.name = "Lubos " + x + ", " + y;
        newCells.transform.position = new Vector3(x, y, -1);
		...
		newCell.transform.parent = MazeObject.transform;
        newCells.transform.parent = MazeObject.transform;
